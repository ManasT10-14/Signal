...
FRAMEWORK_DESCRIPTIONS: dict[int, str] = {
    ...
    # Group F — NEPQ
    20: "Unified NEPQ analysis: 8-phase sequence adherence, diagnostic probing depth, and commitment origin (self-generated vs rep-pushed)",
}
